<?php
Route::get('payu-money-payment', 'App\Http\Controllers\PayuMoneyController@redirectToPayU')->name('redirectToPayU');

Route::post('payu-money-payment', 'App\Http\Controllers\PayuMoneyController@redirectToPayU')->name('redirectToPayU');
