                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 pre-footer-col">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><i class="fa fa-angle-right"></i> <a href="/serviceuse">Service Term of Use</a></li>
                            ...
                            <li><i class="fa fa-angle-right"></i> <a href="javascript:;">Term Of Service</a></li>
                            <li><i class="fa fa-angle-right"></i> <a
                                    href="https://partners.quicksecureindia.com/admin/">Admin Login</a></li>
                    ...
                    <div class="col-md-3 col-sm-6 pre-footer-col">
                        ...
                        <address class="margin-bottom-40">
                            Bistupur office: Holding No-2, Ramdas Bhatta main road,
                            beside Brajdham mandir,
                            Near dhobi Ghat
                            Bistupur -831001<br>
                            Email: <a href="mailto:info@metronic.com">sales@quicksecureindia.com</a><br>
                            <!--Skype: <a href="skype:metronic">Computer solution</a>-->
                        </address>
                    </div>
                    <!-- END BOTTOM CONTACTS -->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <ul class="list-unstyled list-inline pull-right">
                            ...
                            <li><img src="{{ asset('assets/corporate/img/payments/american-express.jpg') }}"
                                    alt="We accept American Express" title="We accept American Express"></li>
                            <li><img src="{{ asset('assets/corporate/img/payments/MasterCard.jpg') }}"
                            ...
                            <li><img src="{{ asset('assets/corporate/img/payments/visa.jpg') }}" alt="We accept Visa"
                    ...
                    <div class="col-md-4 col-sm-4 text-right">
                        <p class="powered">Powered by: <a href="http://www.keenthemes.com/">Insight Infosystem</a>
                        </p>
                    </div>
                    <!-- END POWERED -->
                </div>
