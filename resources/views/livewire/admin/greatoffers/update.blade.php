    ...
    <div>
        <div class="container" style="padding:30px 0;">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <form action="{{ route('admin.greatoffers.update', $data->id) }}" method="POST"
                            ...
                            <div class="row  p-2">
                                <div class="form-group col-sm-4">
                                    ...
                                    <div>
                                        <input onkeyup="slug1(this.value)" type="text" value="{{ $data->title }}" class="form-control input-md"
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <div>
                                        <input value="{{ $data->link }}" type="text" class="form-control input-md"
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <img src="{{ asset('assets/pages/img/sliders') }}/{{ $data->image }}"
                                                class="img-fluid">
                                        </div>
