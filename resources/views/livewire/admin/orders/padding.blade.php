                            ...
                            <div class="row">
                                ...
                                <form action="{{ route('admin.order.filter.data') }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="type" value="pending" class="form-control">
                                ...
                                <div class="col-md-2">
                                    <a href="{{ route('export.orders','pending') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
