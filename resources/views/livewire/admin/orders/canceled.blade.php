<x-adminlayout>
    ...
    <div>
        {{-- @include('livewire.admin.Canceled Order.insert') --}}
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <i class="fas fa-list"> All Canceled Order</i>

                                </div>
                                <form action="{{ route('admin.order.filter.data') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <input type="hidden" name="type" value="canceled" class="form-control">
                                ...
                                <div class="col-md-2">
                                    <a href="{{ route('export.orders','canceled') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
