<x-adminlayout>
    ...
    <div>
        {{-- @include('livewire.admin.Delivered Order.insert') --}}
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <i class="fas fa-list"> All Delivered Order</i>
                                ...
                                <form action="{{ route('admin.order.filter.data') }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="type" value="delivered" class="form-control">
                                ...
                                <div class="col-md-2">
                                    <a href="{{ route('export.orders','delivered') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
